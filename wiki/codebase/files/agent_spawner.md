...
- `auto_packager.py` — `EnhancedAgentSpawner` composes `UltimMCAgentSpawner` as its delegate, per this file's own docstring; not yet given its own page.
